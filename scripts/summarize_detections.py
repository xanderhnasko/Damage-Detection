...
def main():
    ...
    ap.add_argument("--conf_min", type=float, default=0.05, help="Min confidence to keep detections")
    ap.add_argument("--min_iou", type=float, default=0.05, help="Min match_iou to count as TP")
    args = ap.parse_args()
